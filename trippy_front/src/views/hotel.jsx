...
const Hotel = () => {
    ...
    const hotel = async () => {
        try {
            const response = await axios.post("http://localhost:8000/hotels", { name, address, city, country, cuisine })
            ...
            <div className="row">
                <div className="offset-3 col-6 mx-auto">
                    ...
                    <div className="mb-3 row">
                        ...
                        <button type="submit" className="btn btn-primary mb-3" onClick={restaurant}>Add Hotel</button>
                    </div>
                </div>
            </div>
        );
